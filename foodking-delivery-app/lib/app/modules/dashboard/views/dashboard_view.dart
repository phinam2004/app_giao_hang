    ...
    return PopScope(
      ...
      child: Scaffold(
        body: PageView(
          ...
          children: const [HomeView(), HistoryView(), ProfileView()],
          onPageChanged: (index) {
            setState(() {
              _currentPage = index;
              Get.find<HomeController>().getOrderList();
          ...
          items: <BottomBarItem>[
            BottomBarItem(
              icon: Padding(
                ...
                child: ImageIcon(AssetImage(Images.iconHome), size: 24),
              ),
              title: Text('HOME'.tr),
            ...
            BottomBarItem(
              icon: Padding(
                padding: EdgeInsets.only(right: 8.w),
                child: ImageIcon(AssetImage(Images.iconHistory), size: 24),
              ),
            ...
            BottomBarItem(
              icon: Padding(
                padding: EdgeInsets.only(right: 8.w),
                child: ImageIcon(AssetImage(Images.iconProfile), size: 24),
              ),
